...
// ROUTE 3: Update a existing note using : PUT "/api/notes/updatenote". No login required
...
// ROUTE 4: Deleting a existing note using : DELETE "/api/notes/deletenote". No login required
